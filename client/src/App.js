        ...
        <Fade className="mt-3" in={fadeIn}>
          <div>
            {activeTarget.type === 'Wildcard' && (
              <div className="mb-4">
                <h3 className="text-danger text-center fs-3 mb-3">URL</h3>
                ...
                <h4 className="text-danger text-center mb-3 fs-3">Subdomain Scraping</h4>
                ...
                <h4 className="text-danger text-center mb-3 fs-3">Consolidate Subdomains & Discover Live Web Servers - Round 1</h4>
                ...
                <h4 className="text-danger text-center mb-3 fs-3">Brute-Force</h4>
                ...
                <h4 className="text-danger text-center mb-3 fs-3">Consolidate Subdomains & Discover Live Web Servers - Round 2</h4>
                ...
                <h4 className="text-danger text-center mb-3 fs-3">JavaScript/Link Discovery</h4>
                ...
                <h4 className="text-danger text-center mb-3 fs-3">Consolidate Subdomains & Discover Live Web Servers - Round 3</h4>
